...
<div class="container-fluid ">
    <h5>
        <span>
            ...
            <?php echo $hd->tt_hoadon($_GET['maHoaDon'])[0]; ?>,
            <span class="icon icon-inbox"></span>
            <?php echo $hd->tt_hoadon($_GET['maHoaDon'])[1]; ?>,
            <span class="icon icon-time"></span>
            <?php echo $hd->tt_hoadon($_GET['maHoaDon'])[2]; ?>
        </span>
        <br>
        <a href="index.php?quanly=hoadon&ac=lietke&xoaHD=<?php echo $hd->tt_hoadon($_GET['maHoaDon'])[0]; ?>" class="btn btn-default">
            <center>
                <span class="icon icon-cut"></span> Xóa hóa đơn #<?php echo $hd->tt_hoadon($_GET['maHoaDon'])[0]; ?>
            </center>
        </a>
    </h5>
</div>
