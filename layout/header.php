		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbars-rs-food">
				...
				<a href="cart" class="nav-item nav-link">
					...
					<span class="icon-shopping-cart"></span> Sản phẩm - <span class="badge badge-warning"> </span></a>
				<ul class="navbar-nav ml-auto">
					<li class="nav-item">
						<c:if test="${not empty LoginInfor }">
					<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown"></a>
					...
					<c:if test="${ empty LoginInfor }">
						<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">Tài khoản</a>
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
